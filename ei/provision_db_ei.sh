...
if [[ $DB_ENGINE = "postgres" ]] && [[ $WSO2_PRODUCT_VERSION = "6.3.0" ]]; then
    ...
    echo "DECLARE USER_EXIST INTEGER;"$'\n'"BEGIN SELECT COUNT(*) INTO USER_EXIST FROM dba_users WHERE username='WSO2EI_INTEGRATOR_CONFIG_GOV_DB';"$'\n'"IF (USER_EXIST > 0) THEN EXECUTE IMMEDIATE 'DROP USER WSO2EI_INTEGRATOR_CONFIG_GOV_DB CASCADE';"$'\n'"END IF;"$'\n'"END;"$'\n'"/" >> /home/ubuntu/ei/ei630/ei_oracle_user.sql
    echo "CREATE USER WSO2EI_INTEGRATOR_CONFIG_GOV_DB IDENTIFIED BY CF_DB_PASSWORD;"$'\n'"GRANT CONNECT, RESOURCE, DBA TO WSO2EI_INTEGRATOR_CONFIG_GOV_DB;"$'\n'"GRANT UNLIMITED TABLESPACE TO WSO2EI_INTEGRATOR_CONFIG_GOV_DB;" >> /home/ubuntu/ei/ei630/ei_oracle_user.sql
    ...
    echo exit | sqlplus64 WSO2EI_INTEGRATOR_CONFIG_GOV_DB/CF_DB_PASSWORD@//CF_DB_HOST:CF_DB_PORT/WSO2EIDB @/home/ubuntu/ei/ei630/ei_oracle_user_db.sql
    echo exit | sqlplus64 WSO2EI_USER_DB/CF_DB_PASSWORD@//CF_DB_HOST:CF_DB_PORT/WSO2EIDB @/home/ubuntu/ei/ei630/ei_oracle_integrator_config_gov_db.sql
    ...
    echo "DECLARE USER_EXIST INTEGER;"$'\n'"BEGIN SELECT COUNT(*) INTO USER_EXIST FROM dba_users WHERE username='WSO2EI_INTEGRATOR_CONFIG_GOV_DB';"$'\n'"IF (USER_EXIST > 0) THEN EXECUTE IMMEDIATE 'DROP USER WSO2EI_INTEGRATOR_CONFIG_GOV_DB CASCADE';"$'\n'"END IF;"$'\n'"END;"$'\n'"/" >> /home/ubuntu/ei/ei640/ei_oracle_user.sql
    echo "CREATE USER WSO2EI_INTEGRATOR_CONFIG_GOV_DB IDENTIFIED BY CF_DB_PASSWORD;"$'\n'"GRANT CONNECT, RESOURCE, DBA TO WSO2EI_INTEGRATOR_CONFIG_GOV_DB;"$'\n'"GRANT UNLIMITED TABLESPACE TO WSO2EI_INTEGRATOR_CONFIG_GOV_DB;" >> /home/ubuntu/ei/ei640/ei_oracle_user.sql
    ...
    echo exit | sqlplus64 WSO2EI_INTEGRATOR_CONFIG_GOV_DB/CF_DB_PASSWORD@//CF_DB_HOST:CF_DB_PORT/WSO2EIDB @/home/ubuntu/ei/ei640/ei_oracle_user_db.sql
    echo exit | sqlplus64 WSO2EI_USER_DB/CF_DB_PASSWORD@//CF_DB_HOST:CF_DB_PORT/WSO2EIDB @/home/ubuntu/ei/ei640/ei_oracle_integrator_config_gov_db.sql
